...
const ArrowRightIcon = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5">
    <path d="M5 12h14" />
    ...
    <div className="max-w-xl mx-auto bg-surface dark:bg-surface-container border border-border dark:border-border p-5 sm:p-7">
      <div className="flex items-center gap-3 mb-4 pb-3 border-b border-border dark:border-border">
        ...
        <div>
          ...
          <p className="font-mono text-[0.625rem] text-ink-muted dark:text-text-muted">Click to trigger smart-mailto</p>
        </div>
      </div>
