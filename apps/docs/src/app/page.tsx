...
const ZapIcon = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-blue-400 mb-6"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>
);

const Globe2Icon = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-purple-400 mb-6"><circle cx="12" cy="12" r="10"></circle><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"></path><path d="M2 12h20"></path></svg>
);

const ShieldIcon = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round" className="w-10 h-10 text-emerald-400 mb-6"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
);
      ...
      <main className="pt-32 pb-24 px-6 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-zinc-400 max-w-2xl mx-auto mb-12 font-medium">
            A framework-agnostic, zero-dependency library that intelligently intercepts mailto links and routes users to their preferred webmail.
          </p>
        ...
        {/* Features Grid */}
        <div id="features" className="max-w-6xl mx-auto mt-40 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white/[0.02] border border-white/5 p-8 rounded-2xl relative overflow-hidden group">
            ...
            <p className="text-zinc-400 leading-relaxed">
              Built in Vanilla TypeScript. Extremely lightweight at under 8KB gzipped. Doesn't pollute your bundle.
            </p>
          </div>
          <div className="bg-white/[0.02] border border-white/5 p-8 rounded-2xl relative overflow-hidden group">
            ...
            <p className="text-zinc-400 leading-relaxed">
              Intelligently suggests providers based on the user's locale without making a single IP/network request.
            </p>
          </div>
          <div className="bg-white/[0.02] border border-white/5 p-8 rounded-2xl relative overflow-hidden group">
            ...
            <p className="text-zinc-400 leading-relaxed">
              Everything runs locally in the browser. No tracking, no external pings. Fully GDPR compliant by default.
            </p>
          </div>
        </div>
