...
Zero-dependency, framework-agnostic engine that replaces broken `mailto:` links with a geo-aware webmail picker modal. **7.4 KB gzipped. 30 webmail providers. Zero network requests.**
...
| `getAllProviders()`                     | 30 webmail providers plus native and copy actions |
